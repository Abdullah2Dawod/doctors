...
<section class="about_section">
    ...
    <div class="rew" style="display: flex;justify-content: space-between" >
        <div>
            <h4 class="doc0" style="font-family: 'Cairo', sans-serif;">أطبـــاء عـلاج طـبـيـعـي <small>" {{$Physical->count()}} "</small></h4>
        </div>
        <div>
            ...
            <div class="make-3D-space" style="font-family: 'Almarai', sans-serif;">
                <div class="product-card">
                    <div class="product-front">
                        <img src="{{ url('imagedoctor/'.$Physicals->image) }}" alt="" />
                        <div class="image_overlay"></div>
                        <button type="button" class="view_details" data-bs-toggle="modal" data-bs-target="#reservation{{$Physicals->id}}">
                        حجز موعد</button>
                        <div class="statst">
                            <div class="statst-container">
                                <span class="product_name"><small style="color: #178066;">الدكتور/ ة : </small>{{$Physicals->name}}</span>
                                <p>{{$Physicals->university}}</p>
                                <hr style="margin-top: -20px;">
                                <div class="product-options">

                                <p> <o style="color: #178066;">العنوان : </o> {{$Physicals->addres}} .
                                    <br> <o style="color: #178066;">سعر الكشفية : </o> {{$Physicals->price}} شيكل . <br>
                                    <o style="color: #178066;">مواعيد العمل : </o>{{$Physicals->work}} . <br>
                                    <o style="color: #178066;">رقم الجوال :</o> {{$Physicals->mobaile}} . </p>
                                <div class="rating-css" style="margin-top: -35px">
                                    <form>
                                        @csrf

                                    <div class="star-icon">
                                        <input class="inpo" type="radio" value="1" name="product_rating" checked id="rating1{{$Physicals->id}}">
                                        <label for="rating1" class="fa fa-star"></label>
                                        <input class="inpo" type="radio" value="2" name="product_rating" id="rating2{{$Physicals->id}}">
                                        <label for="rating2" class="fa fa-star"></label>
                                        <input class="inpo" type="radio" value="3" name="product_rating" id="rating3{{$Physicals->id}}">
                                        <label for="rating3" class="fa fa-star"></label>
                                        <input class="inpo" type="radio" value="4" name="product_rating" id="rating4{{$Physicals->id}}">
                                        <label for="rating4" class="fa fa-star"></label>
                                        <input class="inpo" type="radio" value="5" name="product_rating" id="rating5{{$Physicals->id}}">
...
<!-- Modal -->
<div class="modal fade" id="reservation{{$Physicals->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="wrapper">
                <div class="card card-1">
                    <div class="card-body" style="font-family: 'Cairo', sans-serif !important;">
                        ...
                        <div class="row">
                            <div class=" col">
                                <label for="">الدكتور/ة : {{$Physicals->name}}</label>
                                </div>
                            <div>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            </div>
                            <div class="col">
                            <label name="">مواعيد العمل : {{$Physicals->work}}</label>
                            </div>
                        </div>
                        <div>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
